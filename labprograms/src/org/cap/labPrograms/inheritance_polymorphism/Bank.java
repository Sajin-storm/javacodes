...
//	Write a java program that creates a Bank Account with withdraw,deposit and interest functions.
	//Also add tester classes that test Savings and Current Account class.
	//package inheritance;
import java.util.*;
public	class Bank
	{
